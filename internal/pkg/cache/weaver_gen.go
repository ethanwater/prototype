...
func init() {
	codegen.Register(codegen.Registration{
		Name:   "vivianlab/internal/pkg/cache/Cache",
		Iface:  reflect.TypeOf((*Cache)(nil)).Elem(),
		Impl:   reflect.TypeOf(impl{}),
		Routed: true,
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return cache_local_stub{impl: impl.(Cache), tracer: tracer, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/internal/pkg/cache/Cache", Method: "Get", Remote: false}), putMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/internal/pkg/cache/Cache", Method: "Put", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return cache_client_stub{stub: stub, getMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/internal/pkg/cache/Cache", Method: "Get", Remote: true}), putMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/internal/pkg/cache/Cache", Method: "Put", Remote: true})}
		},
...
var _ weaver.InstanceOf[Cache] = (*impl)(nil)

// weaver.Router checks.
var _ weaver.RoutedBy[route] = (*impl)(nil)

// Component "impl", router "route" checks.
var _ func(ctx context.Context, key string) string = (&route{}).Get               // routed
var _ func(ctx context.Context, key string, value string) string = (&route{}).Put // routed
...
func (s cache_local_stub) Get(ctx context.Context, a0 string) (r0 string, err error) {
	...
	if span.SpanContext().IsValid() {
		...
		ctx, span = s.tracer.Start(ctx, "cache.Cache.Get", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
...
func (s cache_local_stub) Put(ctx context.Context, a0 string, a1 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.tracer.Start(ctx, "cache.Cache.Put", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
				span.RecordError(err)
				span.SetStatus(codes.Error, err.Error())
...
func (s cache_client_stub) Get(ctx context.Context, a0 string) (r0 string, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "cache.Cache.Get", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s cache_client_stub) Put(ctx context.Context, a0 string, a1 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "cache.Cache.Put", trace.WithSpanKind(trace.SpanKindClient))
	}
