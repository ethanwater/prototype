...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "vivianlab/internal/pkg/utils/echo/T",
		Iface: reflect.TypeOf((*T)(nil)).Elem(),
		Impl:  reflect.TypeOf(impl{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return t_local_stub{impl: impl.(T), tracer: tracer, echoResponseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/internal/pkg/utils/echo/T", Method: "EchoResponse", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return t_client_stub{stub: stub, echoResponseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/internal/pkg/utils/echo/T", Method: "EchoResponse", Remote: true})}
		},
...
func (s t_local_stub) EchoResponse(ctx context.Context, a0 string) (err error) {
	// Update metrics.
	...
	if span.SpanContext().IsValid() {
		...
		ctx, span = s.tracer.Start(ctx, "echo.T.EchoResponse", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
...
func (s t_client_stub) EchoResponse(ctx context.Context, a0 string) (err error) {
	// Update metrics.
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "echo.T.EchoResponse", trace.WithSpanKind(trace.SpanKindClient))
	}
...
func (s t_server_stub) echoResponse(ctx context.Context, args []byte) (res []byte, err error) {
	// Catch and return any panics detected during encoding/decoding/rpc.
	defer func() {
		if err == nil {
			err = codegen.CatchPanics(recover())
...
func (s t_reflect_stub) EchoResponse(ctx context.Context, a0 string) (err error) {
