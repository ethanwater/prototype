...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦6467d7cc:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→vivian/app/handleInterface⟧\n⟦2f15269b:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→vivian⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "vivian/app/handleInterface",
		Iface: reflect.TypeOf((*handleInterface)(nil)).Elem(),
		Impl:  reflect.TypeOf(serverControls{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return handleInterface_local_stub{impl: impl.(handleInterface), tracer: tracer, innerEchoMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivian/app/handleInterface", Method: "InnerEcho", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return handleInterface_client_stub{stub: stub, innerEchoMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivian/app/handleInterface", Method: "InnerEcho", Remote: true})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
...
func (s handleInterface_local_stub) InnerEcho(ctx context.Context, a0 string) (r0 string, err error) {
	...
	if span.SpanContext().IsValid() {
		...
		ctx, span = s.tracer.Start(ctx, "app.handleInterface.InnerEcho", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
...
func (s handleInterface_client_stub) InnerEcho(ctx context.Context, a0 string) (r0 string, err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "app.handleInterface.InnerEcho", trace.WithSpanKind(trace.SpanKindClient))
	}
