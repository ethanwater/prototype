...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "vivianlab/pkg/login/Login",
		Iface: reflect.TypeOf((*Login)(nil)).Elem(),
		Impl:  reflect.TypeOf(login{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return login_local_stub{impl: impl.(Login), tracer: tracer, loginMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/pkg/login/Login", Method: "Login", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return login_client_stub{stub: stub, loginMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/pkg/login/Login", Method: "Login", Remote: true})}
		},
