...
func init() {
	codegen.Register(codegen.Registration{
		Name:  "vivianlab/pkg/admincontrols/Echo",
		Iface: reflect.TypeOf((*Echo)(nil)).Elem(),
		Impl:  reflect.TypeOf(echo{}),
		LocalStubFn: func(impl any, caller string, tracer trace.Tracer) any {
			return echo_local_stub{impl: impl.(Echo), tracer: tracer, echoResponseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/pkg/admincontrols/Echo", Method: "EchoResponse", Remote: false})}
		},
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return echo_client_stub{stub: stub, echoResponseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "vivianlab/pkg/admincontrols/Echo", Method: "EchoResponse", Remote: true})}
		},
...
func (s echo_local_stub) EchoResponse(ctx context.Context, a0 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		...
		ctx, span = s.tracer.Start(ctx, "admincontrols.Echo.EchoResponse", trace.WithSpanKind(trace.SpanKindInternal))
		defer func() {
			if err != nil {
...
func (s echo_client_stub) EchoResponse(ctx context.Context, a0 string) (err error) {
	...
	if span.SpanContext().IsValid() {
		// Create a child span for this method.
		ctx, span = s.stub.Tracer().Start(ctx, "admincontrols.Echo.EchoResponse", trace.WithSpanKind(trace.SpanKindClient))
	}
